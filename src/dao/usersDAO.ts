...
export default class UsersDAO {
  ...
  */
   ...
   */
  static async addUser(userInfo: UserInfo): Promise<DAOResponse> {
    /**
   ...
   * @returns {DAOResponse} Returns either a "success" or an "error" Object
   */
  static async loginUser(email: string, jwt: Jwt): Promise<DAOResponse> {
    try {
      // TODO Ticket: UserInfo Management
   ...
   * @returns {DAOResponse} Returns either a "success" or an "error" Object
   */
  static async logoutUser(email: string): Promise<DAOResponse> {
    try {
      // TODO Ticket: UserInfo Management
   ...
   * @returns {DAOResponse}
   */
  static async updatePreferences(email: string, preferences: any): Promise<Document | UpdateResult> {
    try {
      /**
  ...
  static async checkAdmin(email: string): Promise<boolean | DAOResponse> {
    try {
